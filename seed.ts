...
async function main() {
    try {
        ...
        await prisma.share.createMany({
            data: [
                { id: uuidv4(), userId: allUsers[0].id, tipId: tips[0].id, platform: 'Facebook' },
                { id: uuidv4(), userId: allUsers[1].id, tipId: tips[1].id, platform: 'Twitter' },
                { id: uuidv4(), userId: allUsers[2].id, tipId: tips[2].id, platform: 'Instagram' },
            ],
        });
